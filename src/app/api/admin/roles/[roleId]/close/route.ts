...
import { closeRoleForAdmin } from "@/lib/companies/service";
...
export async function POST(
  ...
  try {
    ...
    return NextResponse.json(await closeRoleForAdmin(actor, roleId));
  } catch (error) {
...
function toErrorResponse(error: unknown): NextResponse {
  ...
  console.error("[api/admin/roles/[roleId]/close]", error);
