...
import { getAdminApplicationDetail } from "@/lib/applications/service";
...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json(await getAdminApplicationDetail(actor, applicationId));
  } catch (error) {
...
function toErrorResponse(error: unknown): NextResponse {
  ...
  console.error("[api/admin/applications/[applicationId]]", error);
