...
import { rejectApplicationForAdmin } from "@/lib/applications/service";
...
export async function POST(
  ...
  try {
    ...
    return NextResponse.json(await rejectApplicationForAdmin(actor, applicationId, body.notes));
  } catch (error) {
...
function toErrorResponse(error: unknown): NextResponse {
  ...
  console.error("[api/admin/applications/[applicationId]/reject]", error);
